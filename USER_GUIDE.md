...
## 🛠 11 tabs ที่ใช้ประโยชน์ได้

### 🎨 Studio · หน้าแรก (landing)
- Gallery ผลงานของคุณทั้งหมด · หน้า drafted-inspired
- **3 sections:** 📌 ที่ปักหมุด · 🏠 ผลงานของฉัน · 🎨 ภาพ render
- คลิก **📍 pin** เก็บงานที่ชอบ · **🔄 เปิด** โหลดกลับมาดู/แก้
- เห็นคะแนน · feasibility · จังหวัด · งบ ในแต่ละการ์ด

### 🌐 Explore · ชุมชนและ seed content
- ถ้ามี approved contributions → แสดงจากชุมชน
- ถ้ายังไม่มี → แสดง 60 KG nodes เป็น seed
- Filter ตาม tag · search title/body
- คลิก **📖 เปิดอ่าน** → รายละเอียดเต็ม + **หน้าที่เกี่ยวข้อง** (จาก KG edges)
- Recursive: คลิกหน้าเกี่ยวข้อง → เปิดต่อ · ← กลับ Gallery ได้ตลอด

### 🧵 วัสดุ · Thai palette picker
- 5 หมวด: 🏠 หลังคา · 🧱 ผนัง · 👣 พื้น · 🚪 ประตู-หน้าต่าง · 🎨 accent
- 25+ วัสดุไทย: ดินเผา · ไม้สัก · คราม · ทอง · ปูนปั้น · หญ้าคา · etc
- คลิก swatch → เลือก (2nd click → ยกเลิก)
- **เลือกแล้ว AI จะใช้ palette นี้** ทั้ง analyze และ mockup
...
| `.html` | เปิด browser · Ctrl+P → Save as PDF (ฟอนต์ไทยครบ) |
| `.pdf` (Pro) | Native PDF ด้วย Sarabun font (ต้อง ship font ก่อน) |
| **📑 Portfolio** | **All-in-one** Thai editorial · cover + brief + palette + mockups + analysis · **สำหรับพรีเซนต์ลูกค้า** |
